...
authenticator = IAMAuthenticator('G4VUnTdxzEAdzVRoMl79SFPGfFintkOjE70vz-oHrmXA')
text_to_speech = TextToSpeechV1(authenticator=authenticator)
text_to_speech.set_service_url('https://api.us-south.text-to-speech.watson.cloud.ibm.com/instances/7701e1c0-636b-4dbf-8a76-49cd0988eea2')
...
def read_audio(ws, timeout):
    ...
    print("* recording your speech now, say anything")
    with open('texttospeech1.mp3','wb') as audio_file:
        res1 = text_to_speech.synthesize('recording your speech now, say anything',accept='audio/mp3',voice='en-US_HenryV3Voice').get_result()
        audio_file.write(res1.content)
    ...
    print("* recoeding now is done and finished")
    with open('texttospeech2.mp3','wb') as audio_file:
        res2 = text_to_speech.synthesize('recoeding now is done and finished',accept='audio/mp3',voice='en-US_HenryV3Voice').get_result()
    ...
    with open('speechtotext.txt','w') as speech_output:
        speech_output.writelines(transcript)
